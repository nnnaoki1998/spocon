Rails.application.routes.draw do
  ...
  # curl -X POST -H "Content-Type: application/json" -d '{"uuid":"6bf871c3-21c8-16ac-4bd8-acab8f6b0ee4","name":"東京バスケサークル","sport_id":3,"icon_path":"cccc","description":"ABCDEFGH","zip_code":"812-0017","address":"福岡市博多区美野島3-22-7"}' 127.0.0.1:3000/team
  post '/team', to: 'team#create'
  # curl -X PATCH -H "Content-Type: application/json" -d '{"uuid":"0ae5b251-bfae-c075-fd04-2b57f1410089","name":"FUKUOKAバスケサークル","sport_id":4,"icon_path":"dddd","description":"ABCDEFGH","zip_code":"814-0014","address":"福岡市中央区平尾3-20-57"}' 127.0.0.1:3000/team/3
