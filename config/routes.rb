Rails.application.routes.draw do
  ...
  # curl -X POST -H "Content-Type: application/json" -d '{"uuid":"c6bf871c3-21c8-16ac-4bd8-acab8f6b0ee4","name":"東京バスケサークル","sport_id":3,"icon_path":"cccc","description":"ABCDEFGH","zip_code":"812-0017","address":"福岡市博多区美野島3-22-7","longitude":3,"latitude":3}' 127.0.0.1:3000/team
